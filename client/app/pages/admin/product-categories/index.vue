<template>
    <div class="p-6">
      ...
      <Modal :isVisible="isFormVisible" title="Product Category Form" :showSave="true" @update:isVisible="isFormVisible = $event" @save="saveCategory">
        ...
        <tbody>
          <tr v-for="category in categories" :key="category.id">
            ...
            <td class="p-2 border-b text-center">
              <i v-if="category.status === 'active'" class="fas fa-check text-green-500"></i>
