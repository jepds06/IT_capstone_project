    ...
    <table class="min-w-full bg-white border border-gray-500">
      ...
      <tbody>
        <tr v-for="(quotation, index) in paginatedQuotations" :key="index">
          <td class="py-2 px-4">{{ `QN-${quotation.id}` }}</td>
          <td class="py-2 px-4">{{ quotation.dateEncoded }}</td>
          <td class="py-2 px-4">{{ getUserName(quotation.userID) }}</td>
          <td class="py-2 px-4">
            {{
              `Requested quotation to ${quotation.quotations.length} supplier(s)`
            }}
          </td>
          <td class="py-2 px-4">{{ quotation.quotationRemarks }}</td>
          <td class="py-2 px-4">
            <button
        ...
        <table class="min-w-full bg-white border border-gray-300 mb-4">
          ...
          <tbody>
            ...
            >
              ...
              <td class="py-2 px-4">{{ supplier?.quotationRemarks }}</td>
              <td class="py-2 px-4">
                <button
